...
export class APIConfigManager {
  ...
  private loadConfig(): APIConfig {
    ...
    const kucoinApiKey = process.env.KUCOIN_API_KEY || '68bc595cdf90c30001d12b8c';
    const kucoinSecretKey = process.env.KUCOIN_SECRET_KEY || 'd76dd066-abb5-4b60-bb0c-bfe5b51ed2dd';
    const kucoinPassphrase = process.env.KUCOIN_PASSPHRASE || 'MegaGamer123';
    const kucoinTestnet = process.env.KUCOIN_TESTNET === 'true';
    
    // Load Telegram credentials from environment variables
    const telegramBotToken = process.env.TELEGRAM_BOT_TOKEN || '8228475079:AAEfjtj3IpC8CaUgC_tiCn3sWy5jV_QRxWM';
    const telegramChatId = process.env.TELEGRAM_CHAT_ID || '6808756043';
